...
smiData.RigidTransform(1).ID = 'B[track-1:-:cart-1]';
...
smiData.RigidTransform(2).ID = 'F[track-1:-:cart-1]';
...
smiData.RigidTransform(3).ID = 'B[cart-1:-:pendulum-1]';
...
smiData.RigidTransform(4).ID = 'F[cart-1:-:pendulum-1]';
...
smiData.RigidTransform(5).ID = 'RootGround[track-1]';
...
smiData.Solid(1).color = [0.95294117647058822 0.75294117647058822 0.75294117647058822];
smiData.Solid(1).opacity = 1;
smiData.Solid(1).ID = 'track*:*Default';
...
smiData.Solid(2).color = [0.35294117647058822 0.35294117647058822 0.35294117647058822];
...
smiData.PrismaticJoint(1).ID = '[track-1:-:cart-1]';
...
smiData.RevoluteJoint(1).ID = '[cart-1:-:pendulum-1]';
